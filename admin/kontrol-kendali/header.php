...
<head>
    ...
    <title>Admin - Monitoring Rumah</title>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        <li class="nav-item <?php if ($title == 'Selamat Datang di Aplikasi Sistem Kendali Otomatis') {
                                                echo 'active';
                                            } ?>">
                        ...
                        <li class="nav-item <?php if ($title == 'Data Rumah') {
                                                echo 'active';
                                            } ?>"">
                            <a href="../rumah.php">
                            <i class="fas fa-home"></i>
                        ...
                        <li class="nav-item <?php if ($title == 'Kontrol Kendali') {
                                                echo 'active';
                                            } ?>"">
                        ...
                        <li class="nav-item <?php if ($title == 'ThingSpeak') {
                                                echo 'active';
                                            } ?>"">
                            <a href="https://thingspeak.com/login?skipSSOCheck=true" target="_blank">
                            <i class="fas fa-globe-americas"></i>
                            <p>Buat Akun Thinkspeak</p>
                            </a>
                        </li>
